#!/usr/bin/env python3
"""
ps3_games_rpcs3 Games Grid Generator
Creates an Xemu-style grid website from your ps3_games_rpcs3 games JSON
...
# Configuration
JSON_FILE = "ps3_games_rpcs3.json"
OUTPUT_HTML = "ps3_games_rpcs3.html"
PUBLIC_INDEX = "public/index.html"
PLACEHOLDER_IMAGE = "https://cdn.gitgpt.chat/rtx/images/ps3_cover_default.png"
RAW_BASE_URL = ""
...
<head>
  ...
  <title>PS3 Games Collection</title>

  <link rel="icon" href="https://cdn.gitgpt.chat/rtx/images/ps3-icon.png" type="image/png">
  <link rel="apple-touch-icon" href="https://cdn.gitgpt.chat/rtx/images/ps3-icon.png" sizes="180x180">
  <link rel="icon" type="image/png" href="https://cdn.gitgpt.chat/rtx/images/ps3-icon.png" sizes="192x192">
  <link rel="icon" type="image/png" href="https://cdn.gitgpt.chat/rtx/images/ps3-icon.png" sizes="512x512">
  <meta itemprop="name" content="PS3 Games Collection">
  <meta property="og:title" content="PS3 Games Collection">
  <meta property="og:url" content="">
  <meta property="og:type" content="website">
  <meta name="twitter:title" content="PS3 Games Collection">
...
<body>
  <div id="saved-search-container">
    <div class="search-row">
      <img src="https://cdn.gitgpt.chat/rtx/images/ps3-icon.png" class="icon" alt="PS3 logo">
      <input type="text" id="saved-search-input" placeholder="Search games...">
      <a href="https://rpcs3.net/" target="_blank">
        <img src="https://cdn.gitgpt.chat/rtx/images/ps3_controller.png" class="icon" alt="PS3">
      </a>
      <a href="https://cdn.gitgpt.chat/rtx/ps3_magazine.html" target="_blank">
        <img src="https://cdn.gitgpt.chat/rtx/images/ps3_magazine.jpg" class="icon" alt="PS3 Magazine">
      </a>
    </div>
...
"""
    ...
    for game in games:
        ...
        <div class="col px-1 mb-4 title-card" data-title-name="{title}" data-title-status="Play">
          <a target="_blank" rel="norefferer" href="https://github.com/igiteam/ps3-covers">
    ...
    function wrapCardsWithLinks() {{
      document.querySelectorAll('.title-card').forEach(card => {{
        ...
        if (url_path) {{
          ...
          link.href = 'https://meyt.netlify.app/search/' + url_path + ' ps3 rpcs3';
...
def main():
    print("🎮 PS3 Games Grid Generator (Xemu Style)")
    print("=" * 50)
    ...
    print(f"✅ Website generated: {PUBLIC_INDEX}")
    print(f"\n📊 Statistics:")
